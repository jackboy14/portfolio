  ...
  return (
    <div name='home' className='w-full h-[800px] pb-44 bg-[#273347]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <h2 className='text-3xl sm:text-3xl font-bold text-[#c5cbff]'>
                I'm a DevOps and full Stack developer
                <p className='text-3xl sm:text-3xl font-bold text-[#c5cbff]'>
                    one of <a className='font-bold inline border-b-4 border-yellow-500' href='/'>Digital Craft</a> member.
                </p>
             </h2>
            <p  className='text-[#c5cbff] py-5 max-w-[500px]'>I'm a full-stack web and mobile Developer.
                  Currently, I'm focused on building responsive full-stack web and mobile application, and on their containerization and deployment on the cloud.</p>
